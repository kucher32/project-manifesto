...
Clone or download the repository from [github.com/kucher32/project-manifesto](https://github.com/kucher32/project-manifesto), copy the contents of `deploy/v0.7.2/` into your project folder, open the folder in Claude Code, and tell it: "read setup.md and install."
...
- `deploy/v0.7.2/` — the installer package; copy this into your project
